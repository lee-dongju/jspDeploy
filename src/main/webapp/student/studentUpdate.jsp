	...
	$("#findAddr").click(function(){
		new daum.Postcode({
	        oncomplete: function(data) {
	            ...
	            $("#zipcodelabel").text(data.zonecode);
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form id="frm" action="/studentUpdate" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<label class="control-label" id="addr1lable">${studentVo.addr1}</label>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" id="addr2label" class="form-control" name="addr2"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<label class="control-label" id="zipcodelabel">${studentVo.zipcd}</label>
							<input type="hidden" name="zipcd" value="${studentVo.zipcd}">
						</div>
					</div>
